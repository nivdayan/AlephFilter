...
public class aleph_tests {
    ...
    public static int payload_size = 32;
    ...
    static public void insert_all_and_then_delete_all(DuplicatingChainedInfiniFilter qf, int num_entries_power) {
        ...
        for (int i = 0; i < max_key; i++) {
            boolean success = qf.insert(i, false, new long[]{0});
            Assert(success);
        }
        ...
        for (int i = 0; i < max_key; i++) {
            ...
            Assert(removed_fp[removed_fp.length - 1] > -1);
            success = qf.search(i);
            //Assert(!success);
        }
    ...
    static public void test3() {
        ...
        DuplicatingChainedInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, bits_per_entry, false, -1, payload_size);
    ...
    static public void test7() {
        ...
        BasicInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, bits_per_entry, false, -1, payload_size);
        qf.fprStyle = FingerprintGrowthStrategy.FalsePositiveRateExpansion.UNIFORM;
    ...
    static public void test10() {
        ...
        int seed = 2;  // 10
        //int num_entries = (int)Math.pow(2, num_entries_power);
        BasicInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, bits_per_entry, true, -1, payload_size);
        qf.fprStyle = FingerprintGrowthStrategy.FalsePositiveRateExpansion.POLYNOMIAL;
        Tests.test_insertions_and_deletes(qf);
        System.out.println("success");
    }
    ...
    static public void test11() {
        ...
        int seed = 2;  // 10
        //int num_entries = (int)Math.pow(2, num_entries_power);
        ChainedInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, bits_per_entry, true, -1, payload_size);
    ...
    static public void test12_() {
        ...
        DuplicatingChainedInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, fp_size + 3, true, 10, payload_size);
        //ChainedInfiniFilter qf = new ChainedInfiniFilter(num_entries_power, bits_per_entry, payload_size);
    ...
    static public void test14() {
        ...
        //int num_entries = (int)Math.pow(2, num_entries_power);
        int fp_size = DuplicatingChainedInfiniFilter.derive_init_fingerprint_size(bits_per_entry - 3, 10);
        DuplicatingChainedInfiniFilter qf = new DuplicatingChainedInfiniFilter(num_entries_power, fp_size + 3, false, 10, payload_size);
        //ChainedInfiniFilter qf = new ChainedInfiniFilter(num_entries_power, bits_per_entry, payload_size);
        qf.fprStyle = FingerprintGrowthStrategy.FalsePositiveRateExpansion.POLYNOMIAL_SHRINK;
        insert_all_and_then_delete_all(qf, 21);
    }
